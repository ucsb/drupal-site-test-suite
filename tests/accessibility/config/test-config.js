...
console.log('   drush utest:alfa --base-url=https://example.com');
console.log('');
console.log('   # Use standard profile');
console.log('   A11Y_PROFILE=standard drush utest:axe-watcher --base-url=https://example.com');
console.log('');
console.log('   # Use custom profile');
console.log('   A11Y_PROFILE=custom A11Y_CUSTOM_TAGS=wcag2a,wcag21aa drush utest:alfa');
