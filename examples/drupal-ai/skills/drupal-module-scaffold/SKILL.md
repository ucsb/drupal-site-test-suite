...
└── tests/src/Unit/<Name>Test.php        # one placeholder test so CI has something to run; name it after what it covers (e.g. <Name>ServiceTest.php)
```
...
| --- | --- |
| Just a hook in `.module` | just the minimum file set above |
